...
```jsonc
{
  ...
  "linkGraph": { "orphanCandidates": ["..."], "orphanDetectionUsedKnownUrls": true, "crawlDepthOutliers": [ { "url": "...", "depth": 5 } ], "brokenInternalLinks": [ { "from": "...", "to": "...", "status": 404 } ], "unverifiedInternalLinks": [ { "from": "...", "to": "..." } ], "sitemapIndexabilityConflicts": [ { "url": "...", "reason": "noindex directive present ..." } ], "note": "..." },
